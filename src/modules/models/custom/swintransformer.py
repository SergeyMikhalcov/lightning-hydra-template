...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        if self.final_upsample == "expand_first":
            ...
            self.up = FinalPatchExpand_X4(input_resolution=(img_size[0]//patch_size[0],img_size[1]//patch_size[1]),dim_scale=4,dim=embed_dim)
...
def test():
    model = SwinTransformer(img_size=(256, 4096), patch_size=(4, 4), in_chans=3, num_classes=1,
