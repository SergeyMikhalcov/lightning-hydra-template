...
from src.datamodules.datasets import NoLabelsDataset
...
class BatteRayDataModule(SingleDataModule):
    def __init__(
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.train_set and not self.valid_set and not self.test_set:
            ...
            train_set = NoLabelsDataset(
                dir_paths = [self.cfg_datasets.get("data_dir")],
                read_mode = "uint16",
                transform=None,
            )
